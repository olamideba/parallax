...
export const ROLE_META: Record<AgentRole, { label: string; dot: string; ink: string; bg: string }> = {
  advocate: { label: 'leslie', dot: '#4F5BB8', ink: '#3C46A0', bg: '#ECEEFA' },      // --agent-1
  auditor: { label: 'karen', dot: '#2F7D72', ink: '#236258', bg: '#E5F1EF' },    // --agent-2
  assessor: { label: 'olamide', dot: '#9A6326', ink: '#7E501C', bg: '#F5EDE2' }, // --agent-3
  arbitrator: { label: 'dumbledore', dot: '#6E5B92', ink: '#574576', bg: '#F0EDF6' },      // --agent-4
  gatekeeper: { label: 'kumar', dot: '#6C7589', ink: '#4B5468', bg: '#EEF1F6' },     // gray lane
};
